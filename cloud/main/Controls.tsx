  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', padding: '14px' }}>
      <ToggleButtonGroup
        ...
        >
          <img src={icons.home} style={{ marginRight: '14px', marginBottom: '2px' }} />
          <Typography>
            Home
          </Typography>
        </StyledToggleButton>
        <StyledToggleButton value='hibernate' aria-label='Away' selected={currentState === 'hibernate'}>
          <img src={icons.away} style={{ marginRight: '14px', marginBottom: '2px' }} />
          <Typography>
            Away
          </Typography>
        </StyledToggleButton>
        <StyledToggleButton value='bedtime' aria-label='Bedtime' selected={currentState === 'bedtime'}>
          <img src={icons.bedtime} style={{ marginRight: '14px', marginBottom: '2px' }} />
          <Typography>
            Bedtime
          </Typography>
        </StyledToggleButton>
        <StyledToggleButton sx={{ backgroundColor: currentState === 'awake' ? 'white' : '', borderRadius: '14px' }}
          ...
          <img src={icons.awake} style={{ marginRight: '14px', marginBottom: '2px' }} />
          <Typography>
            Morning
          </Typography>
        </StyledToggleButton>
        <ToggleButton onClick={(e) => e.preventDefault()} sx={{ marginLeft: '-14px', opacity: 0, width: '14px' }} value='' aria-label='' selected={false} />
        <ToggleButton onClick={(e) => e.preventDefault()} sx={{ marginLeft: '-14px', opacity: 0, width: '14px' }} value='' aria-label='' selected={false} />
